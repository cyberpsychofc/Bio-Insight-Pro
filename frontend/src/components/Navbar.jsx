...
const Navbar = () => {
  ...
  return (
    ...
    >
      <a
  href="https://bioinsght.pro/"
  aria-label="Home"
  className="inline-block transform transition-all duration-300 hover:scale-110 hover:drop-shadow-lg"
>
  <svg
    className="w-[42px] h-[42px] text-gray-800 dark:text-white transition-all duration-300 hover:text-cyan-400 hover:drop-shadow-[0_0_5px_rgba(0,255,255,0.7)] hover:drop-shadow-[0_0_10px_rgba(0,255,255,0.7)] hover:drop-shadow-[0_0_15px_rgba(0,255,255,0.7)]"
    aria-hidden="true"
