            ...
            <div className="grid items-center">
                <div className="grid items-center justify-center mt-20 text-center text-4xl text-gray-300">
                    ...
                    <div className="flex justify-center gap-4 mb-8">
                        <button className="px-4 py-2 bg-gray-900 text-white rounded bg-opacity-75" onClick={() => handlePaste(setSequence1)}><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div className="flex justify-center gap-4 mt-2">
                        <button className="px-4 py-2 bg-gray-900 text-white rounded bg-opacity-75" onClick={() => handlePaste(setSequence2)}>
